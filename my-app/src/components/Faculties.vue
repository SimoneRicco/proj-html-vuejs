...
export default {
  data() {
    return {
      paths: [
        "../../edu/img/Gavel-v2.png",
        "../../edu/img/Coins-tabs-v2.png",
        "../../edu/img/Medicine-tabs-v2.png",
        "../../edu/img/Computer-tabs-v2.png",
        "../../edu/img/Palette-tabs-v2.png",
      ],
      facultiesList: [
        {
          name: "Law Faculty",
